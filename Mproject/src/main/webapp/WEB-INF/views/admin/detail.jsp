...
<div class="container">
	...
	<div><span id = "userId">${board.user.username}</span>
		No.<span id="id"><i>${board.id}</i></span> <br/> name:<span id = "name"><i>${board.user.name} </i></span>
	</div>
	<br />
	<div>
		<h3> ${board.title}</h3>
	...
	<hr />
				...
				<button type="button" class="btn btn-outline-dark mt-auto" id ="btn-deleteAdmin">delete</button>
