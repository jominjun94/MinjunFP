      ...
      <tr>
        ...
        <td>${reply.createDate}</td>
			...
			<a class="btn btn-outline-dark mt-auto"
				href="/board/reply/${reply.id}">enter</a>
				</th>
 		</tr>
 			</c:if>
	</c:forEach>
...
<div class="text-center">
	...
	<c:choose>
		...
		<c:otherwise>
			<a class="btn btn-outline-dark mt-auto" href = "/board/reply?page=0">start</a>
			<a class="btn btn-outline-dark mt-auto" href = "/board/reply?page=${boards.number-1}">&larr;</a>
		</c:otherwise>
	</c:choose>
	...
	<c:forEach begin="${startBlockPage}" end="${endBlockPage}" var="i">
		<c:choose>
			<c:when test="${boards.pageable.pageNumber + 1 == i }">
				<a class="btn btn-outline-dark mt-auto" href = "/board/reply?page=${i-1}">${i}</a>
			</c:when>
			<c:otherwise>
				<a class="btn btn-outline-dark mt-auto" href = "/board/reply?page=${i-1}">${i}</a>
			</c:otherwise>
	...
	<c:choose>
		...
		<c:otherwise>
			<a class="btn btn-outline-dark mt-auto" href = "/board/reply?page=${boards.number+1}">&rarr;</a>
			<a class="btn btn-outline-dark mt-auto" href = "/board/reply?page=${boards.totalPages-1}">last</a>
		</c:otherwise>
	</c:choose>
